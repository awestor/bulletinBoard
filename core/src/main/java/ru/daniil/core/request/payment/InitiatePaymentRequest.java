...
public class InitiatePaymentRequest {
    ...
    @Size(max = 50, message = "Тип платежного метода не может превышать 50 символов")
    @Pattern(regexp = "^[A-Z_]+$", message = "Тип платежного метода должен быть в верхнем регистре с подчеркиваниями")
