...
import ru.daniil.user.service.product_module.product.category.CategoryProcessorServiceImpl;
import ru.daniil.user.service.product_module.product.category.CategoryService;
...
class CategoryProcessorServiceImplTest {
    ...
    void deleteWithReplace_WhenCategoryIsLeafWithProducts_ShouldTransferProducts() {
        ...
        List<ru.daniil.core.entity.base.product.Product> products =
